...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post missions_url, params: { mission: { description: @mission.description, title: @mission.title, video_url: @mission.video_url } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { description: @mission.description, title: @mission.title, video_url: @mission.video_url } }
